...
public class RobotMap {
    ...
    public static final int FRONT_LEFT_DRIVE_MOTOR_CAN_ID = 1,
     ...
     BACK_LEFT_DRIVE_MOTOR_CAN_ID = 2,
     BACK_RIGHT_DRIVE_MOTOR_CAN_ID = 4;

    /** Steering Motor CAN IDs */
    public static final int FRONT_LEFT_STEERING_MOTOR_CAN_ID = 5,
    ...
    public static final int ARM_PIVOT_MOTOR_CAN_ID = 9;

    /** Intake Roller Motor CAN IDs */
    public static final int LEFT_INTAKE_ROLLER_MOTOR_CAN_ID = 10, RIGHT_INTAKE_ROLLER_MOTOR_CAN_ID = 11;
