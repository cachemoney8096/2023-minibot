...
package frc.robot.subsystems.ClawLimelight;
...
public class ClawLimelight extends SubsystemBase {
  ...
  private final String kTargetClass;
   ...
   */
  public ClawLimelight(double angleDegrees, double heightMeters, double targetHeightMeters, String targetClass) {
